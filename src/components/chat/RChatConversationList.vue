<script setup lang="ts">
  ...
  function getDropdownOptions(conv: ChatConversation): DropdownOption[] {
    const opts: DropdownOption[] = [
      ...
      {
        label: conv.favorite ? '取消收藏' : '收藏',
        key: conv.favorite ? 'unfavorite' : 'favorite',
      },
...
<template>
  <div class="r-chat-conv-list">
    <div class="r-chat-conv-list__header">
      <NButton type="primary" block aria-label="新建对话" @click="$emit('create')"
        >新建对话</NButton
      >
      <NInput
          ...
          >
            ...
            >
                ...
                <div class="r-chat-conv-list__item-actions">
                  <NButton
                    ...
                    :class="[
                      ...
                      { 'r-chat-conv-list__item-favorite--active': conv.favorite },
                    ]"
              ...
              <div class="r-chat-conv-list__item-sub">
                <span class="r-chat-conv-list__item-time">{{
                  formatRelativeTime(conv.updated_at)
                }}</span>
                <span class="r-chat-conv-list__item-meta"
                  >{{ conv.message_count }} 条 · {{ conv.model }}</span
                >
              </div>
            </div>
          </NDropdown>
