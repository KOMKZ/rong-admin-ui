  ...
  function handleEvent(evt: FlowTimelineEvent) {
    ...
    switch (evt.type) {
      ...
      case 'node_exit': {
        ...
        nodeStatus.value[evt.node_id] = {
          status: 'completed',
          duration: ex?.enterTime ? evt.timestamp - ex.enterTime : undefined,
        }
        break
      }
    }
...
<style scoped>
  ...
  .r-flow-timeline__entry--node_enter .r-flow-timeline__badge {
    background: #dbeafe;
    color: #2563eb;
  }
  .r-flow-timeline__entry--node_exit .r-flow-timeline__badge {
    background: #dcfce7;
    color: #16a34a;
  }
  .r-flow-timeline__entry--tool_call .r-flow-timeline__badge {
    background: #fef3c7;
    color: #d97706;
  }
  .r-flow-timeline__entry--tool_result .r-flow-timeline__badge {
    background: #ede9fe;
    color: #6366f1;
  }
  .r-flow-timeline__node {
    font-weight: 500;
    color: #374151;
  }
