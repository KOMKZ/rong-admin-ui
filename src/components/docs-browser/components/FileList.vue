  ...
  <div class="r-docs-file-list" data-testid="docs-file-list">
    <div class="r-docs-file-toolbar">
      ...
      <div ref="sortPopoverRef" class="r-docs-sort-popover">
        ...
        <div v-if="sortMenuOpen" class="r-docs-sort-menu" role="menu" data-testid="docs-sort-menu">
          <button
...
<script lang="ts" setup>
  ...
  const sortModeLabel = computed(() => {
    return (
      sortModeOptions.find((option) => option.key === currentSortModeKey.value)?.label ||
      '按更新时间（新-旧）'
    )
  })
