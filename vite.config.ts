  ...
  build: {
    lib: {
      entry: {
        ...
        'app-devtools/index': resolve(__dirname, 'src/app-devtools/index.ts'),
        'app-menu/index': resolve(__dirname, 'src/app-menu/index.ts'),
        ...
        'components/form-renderer/index': resolve(
          __dirname,
        ...
        'components/crud-form-dialog/index': resolve(
          __dirname,
          'src/components/crud-form-dialog/index.ts',
        ),
        ...
        'components/page-skeleton/index': resolve(
          __dirname,
        ...
        'components/password-strength/index': resolve(
          __dirname,
          'src/components/password-strength/index.ts',
        ),
        'components/check-card-group/index': resolve(
          __dirname,
          'src/components/check-card-group/index.ts',
        ),
        'components/check-button-group/index': resolve(
          __dirname,
          'src/components/check-button-group/index.ts',
        ),
        ...
        'components/notification-center/index': resolve(
          __dirname,
        ...
        'components/markdown-preview/index': resolve(
          __dirname,
        ...
        'components/rich-text-editor/index': resolve(
          __dirname,
        ...
        'components/settings-manager/index': resolve(
          __dirname,
