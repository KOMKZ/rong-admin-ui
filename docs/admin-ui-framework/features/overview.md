...
| 页面骨架       | components/page-layout (RListPage, RFormPage, RDetailPage, RSectionCard) | ✅ 已实现 |
...
| 图片裁切上传   | components/image-crop-upload (RImageCropUpload)                          | ✅ 已实现 |
| 金额展示与输入 | components/money (RMoneyText, RMoneyInput)                               | ✅ 已实现 |
...
// 组件
import { RListPage, RFormPage, RSectionCard } from '@rong/admin-ui'
...
import {
  RProTreeEditor,
  createArticleFolderAdapter,
} from '@rong/admin-ui/components/pro-tree-editor'
```
