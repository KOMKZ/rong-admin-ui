...
| 接口                 | 路径                                  | 说明                                   |
| -------------------- | ------------------------------------- | -------------------------------------- |
| ImageCropOptions     | components/image-crop-upload/types.ts | 裁切比例、输出尺寸、输出 MIME 配置     |
| ImageCropResult      | components/image-crop-upload/types.ts | 裁切输出结果（file/sourceFile/canvas） |
| ImageCropLocale      | components/image-crop-upload/types.ts | 裁切弹窗文案覆盖                       |
