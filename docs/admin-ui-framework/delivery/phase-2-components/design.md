...
5. 在 rong-admin-webdemo 初始化项目并接入框架验证
6. 建立组件可视化 Story 演示页
...
- **框架仓库纯净**：Story/Demo 放在消费方（rong-admin-webdemo），不污染框架仓库
- **web-consumption 硬门禁**：框架每新增能力必须在 rong-admin-webdemo 有调用证据
